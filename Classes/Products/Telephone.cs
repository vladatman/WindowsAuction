...
namespace AuctionProgram.Classes.Products
{
    class Telephone : Product
    {
        ...
        public int BatteryPower { get => batteryPower; set => batteryPower = value; }

        public Telephone(int id, string brand, string model, string color, int batteryPower, int money, DateTime expTime, MainForm mainForm)
        {
            this.Id = id;
            this.Brand = brand;
            this.Model = model;
        ...
        public override void render()
        {
            ...
            pictureBox.Image = Properties.Resources.telephone;
        ...
        public override void showInfo()
        {
            ...
            detailForm.picture.Image = Properties.Resources.telephone;
            ...
            sb.AppendFormat("Brand:          {0}", this.Brand).AppendLine()
              ...
              .AppendFormat("Battery Power:  {0}%", this.BatteryPower);
